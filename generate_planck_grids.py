...
-----
    ...
    python generate_planck_grids.py --n_jobs -1                        # use all CPU cores (default n_grid=50, n_tri1=n_tri2=100, this is very expensive)
...
def generate(n_grid=50, n_tri1=100, n_tri2=100, x1_min=1e-3,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_tri1', type=int, default=100, help='triangle grid: x1 resolution')
    parser.add_argument('--n_tri2', type=int, default=100, help='triangle grid: x2 resolution')
